<div class="container py-4">
    <x-table-responsive>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach($courses as $course)
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="text-sm text-gray-500">Alunos matrículados</div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        @switch($course->status)
                            ...
                            @case(3)
                                ...
                                @break
                            @default
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">N/A</span>
                        @endswitch
                    </td>
        ...
        @else
            <div class="px-6 py-4">Não existem registros</div>
        @endif
