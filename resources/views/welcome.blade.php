...
{{--     
    <section class="mt-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8 ">
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{ asset('img/home/img-grid-01.jpg') }}" alt="">
                </figure>
                <header>
                    <h1 class="mt-2 text-center text-xl text-gray-700">Cursos e Projetos</h1>
                </header>
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{ asset('img/home/img-grid-02.jpg') }}" alt="">
                </figure>
                <header>
                    <h1 class="mt-2 text-center text-xl text-gray-700">Sistemas Internos</h1>
                </header>
                <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit modi est vero omnis architecto doloremque natus error!</p>
            </article>
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{ asset('img/home/img-grid-03.jpg') }}" alt="">
                </figure>
                <header>
                    <h1 class="mt-2 text-center text-xl text-gray-700">Banco de dados</h1>
                </header>
                <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit modi est vero omnis architecto doloremque natus error!</p>
            </article>
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{ asset('img/home/img-grid-04.jpg') }}" alt="">
                </figure>
                <header>
                    <h1 class="mt-2 text-center text-xl text-gray-700">Estações de trabalho</h1>
                </header>
                <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit modi est vero omnis architecto doloremque natus error!</p>
            </article>                                    
        </div>
            ...
            @foreach($courses as $course)
                <article class="bg-white shadow-lg rounded overflow-hidden">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <a href="{{ route('courses.show', $course) }}" class="block text-center w-full mt-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Informações
                        </a>
                </div>
                </article>                
